...
const clivalue_t valueTable[] = {
	...
	{ "flapmode", VAR_UINT8, &cfg.flapmode, BASIC_FLAP, ADV_FLAP },
	...
	{ "S2_trim", VAR_INT16, &cfg.servotrim[2], 1200, 1700 },
	{ "S3_trim", VAR_INT16, &cfg.servotrim[3], 1200, 1700 },
	{ "S4_trim", VAR_INT16, &cfg.servotrim[4], 1200, 1700 },
	{ "S5_trim", VAR_INT16, &cfg.servotrim[5], 1200, 1700 },
	{ "S6_trim", VAR_INT16, &cfg.servotrim[6], 1200, 1700 },
	{ "S7_trim", VAR_INT16, &cfg.servotrim[7], 1200, 1700 },	
	...
	{ "s1_max", VAR_UINT16, &cfg.servoendpoint_high[1], 1000, 2000 },
	{ "s2_min", VAR_UINT16, &cfg.servoendpoint_low[2], 1000, 2000 },
	{ "s2_max", VAR_UINT16, &cfg.servoendpoint_high[2], 1000, 2000 },		
	{ "s3_min", VAR_UINT16, &cfg.servoendpoint_low[3], 1000, 2000 },
	{ "s3_max", VAR_UINT16, &cfg.servoendpoint_high[3], 1000, 2000 },	
	{ "s4_min", VAR_UINT16, &cfg.servoendpoint_low[4], 1000, 2000 },
	{ "s4_max", VAR_UINT16, &cfg.servoendpoint_high[4], 1000, 2000 },
	{ "s5_min", VAR_UINT16, &cfg.servoendpoint_low[5], 1000, 2000 },
	{ "s5_max", VAR_UINT16, &cfg.servoendpoint_high[5], 1000, 2000 },
	{ "s6_min", VAR_UINT16, &cfg.servoendpoint_low[6], 1000, 2000 },
	{ "s6_max", VAR_UINT16, &cfg.servoendpoint_high[6], 1000, 2000 },		
	{ "s7_min", VAR_UINT16, &cfg.servoendpoint_low[7], 1000, 2000 },
	{ "s7_max", VAR_UINT16, &cfg.servoendpoint_high[7], 1000, 2000 },	
	{ "s0_rev", VAR_INT8, &cfg.servoreverse[0], -1, 1 },	
	{ "s1_rev", VAR_INT8, &cfg.servoreverse[1], -1, 1 },	
	{ "s2_rev", VAR_INT8, &cfg.servoreverse[2], -1, 1 },	
	{ "s3_rev", VAR_INT8, &cfg.servoreverse[3], -1, 1 },	
	{ "s4_rev", VAR_INT8, &cfg.servoreverse[4], -1, 1 },	
