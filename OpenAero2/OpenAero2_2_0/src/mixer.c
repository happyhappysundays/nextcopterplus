...
const channel_t AEROPLANE_MIX[MAX_OUTPUTS] PROGMEM = 
{
	...
	{0,MOTOR,THROTTLE,100,NOCHAN,0,OFF,OFF,OFF,OFF,OFF,NOMIX,0,NOMIX,0,},	// ServoOut1 (Throttle)
	{0,ASERVO,AILERON,100,NOCHAN,0,ON,OFF,OFF,ON,OFF,NOMIX,0,NOMIX,0,},		// ServoOut2 (Left aileron)
	{0,ASERVO,ELEVATOR,100,NOCHAN,0,OFF,ON,OFF,OFF,ON,NOMIX,0,NOMIX,0,},	// ServoOut3 (Elevator)
	{0,ASERVO,RUDDER,100,NOCHAN,0,OFF,OFF,ON,OFF,OFF,NOMIX,0,NOMIX,0,},		// ServoOut4 (Rudder)
	{0,ASERVO,NOCHAN,0,NOCHAN,0,ON,OFF,OFF,ON,OFF,NOMIX,0,NOMIX,0,},		// ServoOut5 (Right aileron)
	{0,ASERVO,NOCHAN,0,NOCHAN,0,OFF,OFF,OFF,OFF,OFF,NOMIX,0,NOMIX,0,},		// ServoOut6
	{0,ASERVO,NOCHAN,0,NOCHAN,0,OFF,OFF,OFF,OFF,OFF,NOMIX,0,NOMIX,0,},		// ServoOut7
	{0,ASERVO,NOCHAN,0,NOCHAN,0,OFF,OFF,OFF,OFF,OFF,NOMIX,0,NOMIX,0,},		// ServoOut8
}; 
...
const channel_t FLYING_WING_MIX[MAX_OUTPUTS] PROGMEM = 
{
	...
	{0,MOTOR,THROTTLE,100,NOCHAN,0,OFF,OFF,OFF,OFF,OFF,NOMIX,0,NOMIX,0,},	// ServoOut1 (Throttle)
	{0,ASERVO,AILERON,50,ELEVATOR,50,ON,ON,OFF,ON,ON,NOMIX,0,NOMIX,0,},		// ServoOut2 (Left elevon)
	{0,ASERVO,AILERON,-50,ELEVATOR,50,ON,ON,OFF,ON,ON,NOMIX,0,NOMIX,0,},	// ServoOut3 (Right elevon)
	{0,ASERVO,RUDDER,100,NOCHAN,0,OFF,OFF,ON,OFF,OFF,NOMIX,0,NOMIX,0,},		// ServoOut4 (Rudder)
	{0,ASERVO,NOCHAN,0,NOCHAN,0,OFF,OFF,OFF,OFF,OFF,NOMIX,0,NOMIX,0,},		// ServoOut5 
	{0,ASERVO,NOCHAN,0,NOCHAN,0,OFF,OFF,OFF,OFF,OFF,NOMIX,0,NOMIX,0,},		// ServoOut6
	{0,ASERVO,NOCHAN,0,NOCHAN,0,OFF,OFF,OFF,OFF,OFF,NOMIX,0,NOMIX,0,},		// ServoOut7
	{0,ASERVO,NOCHAN,0,NOCHAN,0,OFF,OFF,OFF,OFF,OFF,NOMIX,0,NOMIX,0,},		// ServoOut8
}; 
...
const channel_t CAM_STAB[MAX_OUTPUTS] PROGMEM = 
{
	...
	{0,ASERVO,NOCHAN,0,NOCHAN,0,OFF,OFF,OFF,OFF,OFF,NOMIX,0,NOMIX,0,},		// ServoOut1
	{0,ASERVO,NOCHAN,0,NOCHAN,0,OFF,ON, OFF,OFF,ON, NOMIX,0,NOMIX,0,},		// ServoOut2 (Pitch axis)
	{0,ASERVO,NOCHAN,0,NOCHAN,0,OFF,OFF,ON, OFF,OFF,NOMIX,0,NOMIX,0,},		// ServoOut3 (Yaw axis)
	{0,ASERVO,NOCHAN,0,NOCHAN,0,ON,OFF,OFF,ON, OFF,NOMIX,0,NOMIX,0,},		// ServoOut4 (Roll axis)
	{0,ASERVO,NOCHAN,0,NOCHAN,0,OFF,OFF, OFF,OFF,OFF,NOMIX,0,NOMIX,0,},		// ServoOut5 
	{0,ASERVO,ELEVATOR,100,NOCHAN,0,OFF,ON,OFF,OFF,ON, NOMIX,0,NOMIX,0,},	// ServoOut6 (Pitch axis)
	{0,ASERVO,RUDDER,100,NOCHAN,0,OFF,OFF,ON, OFF,OFF,NOMIX,0,NOMIX,0,},	// ServoOut7 (Yaw axis)
	{0,ASERVO,AILERON,100,NOCHAN,0,ON,OFF,OFF,ON, OFF,NOMIX,0,NOMIX,0,},	// ServoOut8 (Roll axis)
