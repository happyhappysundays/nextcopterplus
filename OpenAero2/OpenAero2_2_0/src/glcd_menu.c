...
//************************************************************
//															// Status menu
const char StatusText0[]  PROGMEM = "Version:   V1.4 B2";	// <-- Change version number here !!!
...
const char MainMenuItem110[] PROGMEM = "10. OUT1 Mixer";
const char MainMenuItem12[] PROGMEM = "11. OUT2 Mixer";
const char MainMenuItem13[] PROGMEM = "12. OUT3 Mixer";
const char MainMenuItem14[] PROGMEM = "13. OUT4 Mixer";
const char MainMenuItem15[] PROGMEM = "14. OUT5 Mixer";
const char MainMenuItem16[] PROGMEM = "15. OUT6 Mixer";
const char MainMenuItem17[] PROGMEM = "16. OUT7 Mixer";
const char MainMenuItem18[] PROGMEM = "17. OUT8 Mixer";
const char MainMenuItem20[] PROGMEM = "18. Servo direction";
const char MainMenuItem21[] PROGMEM = "19. Servo trim (%)";
...
//
const char MixerItem00[]  PROGMEM = "Device:";				// Mixer menu items
const char MixerItem0[] PROGMEM = "RC source A:";
...
const char MixerItem42[] PROGMEM = "Motor";
//
...
//
const char GeneralText4[] PROGMEM =  "Low";					// PWM output modes
...
const char* const text_menu[] PROGMEM =
	{
		...
		//
		StatusText9, ChannelRef10, ChannelRef12, SensorMenuItem3,							// 18 to 21
		//
		...
		// 
		RXMode0, RXMode44, RXMode2, RXMode3, RXMode1,										// 48 to 52
		
		Dummy0, Dummy0,  Dummy0,															// 53 to 55
		//
		FSmode0, FSmode1, 																	// 56 and 57 Fixed, Adv.
		//
		Dummy0,  Dummy0, 																	// LiPo, NiMh
		//
		...
		//
		RCMenuItem1, RCMenuItem30, RCMenuItem0, RCMenuItem2, RCMenuItem4, 					// 149 to 159 rc menu
		...
		//
		StatusText7, MixerMenuItem0, Contrast0, GeneralText3,								// 165 to 175 general
		MainMenuItem6, GeneralText10, BattMenuItem2,										// Don't forget to change the CONTRAST define in menu_driver.c
		...
		//
		MixerItem00, MixerItem0, MixerItem2, MixerItem13, MixerItem2,						// 214 to 227 Mixers
