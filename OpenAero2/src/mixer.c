...
*/
	// Debug - all sensors ON
	{0,THROTTLE,NORMAL,100,ON,NORMAL,ON,NORMAL,ON,NORMAL,ON,NORMAL,ON,NORMAL,-100,100,0}, 	 	// ServoOut1
	{0,PRESET1,NORMAL,100,ON,NORMAL,ON,NORMAL,ON,NORMAL,ON,NORMAL,ON,NORMAL,-100,100,0},  		// ServoOut2
	{0,PRESET2,NORMAL,100,ON,NORMAL,ON,NORMAL,ON,NORMAL,ON,NORMAL,ON,NORMAL,-100,100,0},  		// ServoOut3
	{0,PRESET3,NORMAL,100,ON,NORMAL,ON,NORMAL,ON,NORMAL,ON,NORMAL,ON,NORMAL,-100,100,0},  	 	// ServoOut4
	{0,ELEVATOR,NORMAL,100,ON,NORMAL,ON,NORMAL,ON,NORMAL,ON,NORMAL,ON,NORMAL,-100,100,0}, 		// ServoOut5
	{0,AILERON,NORMAL,100,ON,NORMAL,ON,NORMAL,ON,NORMAL,ON,NORMAL,ON,NORMAL,-100,100,0}, 		// ServoOut6
	{0,FLAP,NORMAL,100,ON,NORMAL,ON,NORMAL,ON,NORMAL,ON,NORMAL,ON,NORMAL,-100,100,0}, 			// ServoOut7
	{0,RUDDER,NORMAL,100,ON,NORMAL,ON,NORMAL,ON,NORMAL,ON,NORMAL,ON,NORMAL,-100,100,0}, 		// ServoOut8
